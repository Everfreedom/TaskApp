...
public class InputActivity extends AppCompatActivity {
    ...
    private EditText mTitleEdit, mContentEdit ,mCategorytEdit ;
    private Task mTask;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mCategorytEdit = (EditText)findViewById(R.id.category_edit_text);
        ...
        if (mTask == null) {
            ...
            mCategorytEdit.setText(mTask.getCategory());
    ...
    private void addTask() {
        ...
        String category =  mCategorytEdit.getText().toString();
